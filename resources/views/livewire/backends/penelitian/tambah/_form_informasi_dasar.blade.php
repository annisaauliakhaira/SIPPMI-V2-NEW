...
<div class="row">
    <div class="col-lg-2">
        <x-label for="pengusul" value="Pengusul"/>
    </div>
    <div class="col-lg-10">
        <div class="form-group">
            <x-select wire:model="pengusul_id">
                <option value="">--Pilihan--</option>
                @foreach ($pengusul as $data_pengusul)
                    <option value="{{ $data_pengusul->id }}">{{ $data_pengusul->nama }}</option>
                @endforeach
            </x-select>
        </div>
    </div>
