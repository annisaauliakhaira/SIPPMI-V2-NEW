        ...
        <form action="#" method="get">
            <x-card-body>
                ...
                <ul id="progressbar" class="text-center">
                    ...
                    <li class="active" id="confirm"><strong>Submit</strong></li>
                </ul>
                <div class="progress">
                ...
                <fieldset>
                    <div class="form-card">
                        ...
                        @include('livewire.backends.penelitian.tambah._form_view')
                    </div> 
                </fieldset>                
                <div class="mt-2">
                    <button type="button" wire:click="back" class="btn btn-primary">Back</button>
                    <button type="button" wire:click="next" class="btn btn-primary">Finish</button>
