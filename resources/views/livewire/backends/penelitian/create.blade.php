        ...
        <x-card-body>
            ...
            <form id="msform" wire:submit.prevent="submit">
                ...
                <ul id="progressbar" class="text-center">
                    ...
                    <li id="ringkasan"><strong>Ringkasan</strong></li>
                    <li id="peneliti"><strong>Peneliti</strong></li>
                ...
                <fieldset>
                    @if ($step == 0)
                            ...
                            <div class="form-card">
                                ...
                                @include('livewire.backends.penelitian._form')
                            </div> 
                ...
                <fieldset>
                    @if ($step == 1)
                            ...
                            <div class="form-card">
                                ...
                                @include('livewire.backends.penelitian._ringkasan')
                            </div> 
                            {{-- <input type="button" name="next" class="next action-button" value="Selanjutnya" /> 
                ...
                <fieldset>
                    @if ($step == 2)
                            ...
                            <div class="form-card">
                                ...
                                @include('livewire.backends.penelitian.peneliti')
                            </div> 
