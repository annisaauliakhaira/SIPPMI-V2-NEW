<div>
    ...
    <x-card>
        <x-card-body>
            <div>
            <h4 ><span class="fi-rr-edit"></span> Buat Usulan Penelitian</h4>
            </div>
        <br>
        @csrf
            <!-- progressbar -->
            <div id="progressbar" class="text-center">
                ...
                <li class="" id="ringkasan"><strong>Ringkasan</strong></li>
            ...
            <fieldset>
                <div class="form-card">
                    ...
                    <form action="#" method="get" wire:submit.prevent="store">
                        @include('livewire.frontends.penelitian.tambah._form_informasi_dasar')
                </div> 
            </fieldset>                
            <div class="mt-2">
