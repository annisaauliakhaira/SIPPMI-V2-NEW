...
{
    public $penelitian, $dosen, $penelitian_anggota, $penelitian_biaya;
    ...
    public function render()
    {
        ...
        $this->penelitian_anggota = PenelitianAnggota::all();
        $this->penelitian_biaya = PenelitianBiaya::all();
        return view('livewire.frontends.penelitian.tambah.review', [
    ...
    {
        return redirect()->route('frontend.penelitian.index', $this->penelitian);
    }
